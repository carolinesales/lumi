...
//
// Calendário mensal compacto para a sidebar da Home no desktop/tablet.
// Reaproveita os estilos e lógica do Cronograma (CalendarViews + EventPill),
// mas adaptado para um formato mais estreito com lista de próximos cuidados.
