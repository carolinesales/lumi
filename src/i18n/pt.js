const pt = {
  ...
  ti_oscilacao: 'O Lumi percebeu uma oscilação recente. Vale observar eventos como calor, química, queda ou ressecamento.',
  ti_estavel: 'Seu Hair Score está relativamente estável. Pequenos registros ajudam o Lumi a entender melhor sua evolução.',
  ht_titulo: 'Leitura dos fios',
  ht_subtitulo: 'O Lumi acompanha mudanças e padrões percebidos nos seus registros.',
  ht_aria_info: 'Entender leitura dos fios',
  ht_hoje: 'Hoje',
  ht_filtro_periodo: 'Filtrar período',
  ht_registro: 'registro',
  ht_registros: 'registros',
  ht_insights: 'Insights Lumi',
  ht_vazio_titulo: 'A leitura aparece com os registros',
  ht_vazio_desc: 'Ao registrar cuidados, hábitos e mudanças, o Lumi começa a interpretar como seus fios respondem.',
  ht_modal_titulo: 'Como o Lumi lê seus fios?',
  ht_modal_desc: 'A leitura combina seus registros recentes, cuidados concluídos e variações do Hair Score para perceber como seus fios estão respondendo.',
  ht_modal_entendi: 'Entendi',
  ht_info_1: 'A curva mostra o movimento dos últimos registros, não uma nota isolada.',
  ht_info_2: 'A interpretação transforma pequenos registros em sinais mais fáceis de entender.',
  ht_info_3: 'É uma orientação de autocuidado e não substitui avaliação profissional.',
  clima_sem_local: 'Ative a localização para receber insights do clima.',
  clima_seco: 'Umidade baixa em {cidade}. Capriche na hidratação hoje.',
  clima_umido: 'Alta umidade hoje. Use um óleo ou creme mais consistente para reduzir o frizz.',
  clima_calor: 'Calor em {cidade}. Use proteção térmica antes de sair.',
  clima_equilibrado: 'Clima equilibrado em {cidade}. Ótimo dia para manter sua rotina.',
  ins_titulo: 'Insight do dia',
  ins_sensacao: 'Sensação',
  qc_titulo: 'Diário Lumi',
  qc_desc_feito: 'Seu dia já foi registrado. O Lumi vai usar essas informações para acompanhar padrões e evolução dos seus fios.',
  qc_desc_pendente: 'Um resumo dos cuidados, hábitos e sensações do seu dia.',
  qc_btn_abrir: 'Abrir registro',
  qc_btn_registrar: 'Registrar',
  qc_aria_abrir: 'Abrir registro do dia',
  qc_aria_registrar: 'Registrar meu dia',
  ...
  rot_min: 'min',
  rot_no_score: 'no Lumi Score',
  mc_hoje: 'Hoje',
  mc_amanha: 'Amanhã',
  mc_mes_anterior: 'Mês anterior',
  mc_proximo_mes: 'Próximo mês',
  mc_dias: ['Dom', 'Seg', 'Ter', 'Qua', 'Qui', 'Sex', 'Sáb'],
